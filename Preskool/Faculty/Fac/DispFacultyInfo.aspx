<%@ Page Title="" Language="C#" MasterPageFile="~/Faculty/Fac/Fac2.Master" AutoEventWireup="true" CodeBehind="DispFacultyInfo.aspx.cs" Inherits="Preskool.Faculty.Fac.WebForm6" %>
...
<div class="profile-info-blk">
    ...
    <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT [subid] FROM [faculty_mstr]">
    </asp:SqlDataSource>
</div>
</div>
</div>
...
<h3 class="title instructor-text"><a href="course-details.html.html">Information About UI/UX Design Degree</a></h3>
...
<div class="edu-detail">
<h6>Email</h6>
<p><a href="javascript:;"><span class="__cf_email__" data-cfemail="4228272c2c3b352b2e312d2c02273a232f322e276c212d2f">[email&#160;protected]</span></a></p>
</div>
</div>
<div class="edu-wrap">
<div class="edu-name">
