...
<%--<input type="text" class="form-control" placeholder="Enter your Email">--%>
    <asp:TextBox ID="txt_sdesc" runat="server" class="form-control" TextMode="MultiLine"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<%--<input type="text" class="form-control" placeholder="Birth of Date">--%>
    <asp:TextBox ID="txt_sem" runat="server" class="form-control"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<%--<input type="text" class="form-control" placeholder="Address">--%>
    <asp:TextBox ID="txt_pay" runat="server" class="form-control"></asp:TextBox>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<%--<input type="text" class="form-control" placeholder="Address">--%>
    <asp:TextBox ID="txt_SubUrl" runat="server" class="form-control"></asp:TextBox>
</div>
</div>
