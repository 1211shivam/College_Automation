                        ...
                        <div class="login-right-wrap">
                            ...
                            <form runat="server">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txt_fac_name" runat="server" class="form-control" required=""></asp:TextBox>
                                    <span class="profile-views"><i class="fas fa-user-circle"></i></span>
                                </div>
                                <div class="form-group">
                                    <label>Mobile Number <span class="login-danger">*</span></label>
                                    <%--<input class="form-control" type="text">--%>
                                    <asp:TextBox ID="txt_fac_mob" runat="server" class="form-control"  TextMode="Number"></asp:TextBox>
