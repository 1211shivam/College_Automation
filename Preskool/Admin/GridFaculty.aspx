                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="DispApproveFac.aspx" class="btn btn-outline-gray me-2"><i class="feather-list"></i></a>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="student-box flex-fill">
                                                            <div class="student-img">
                                                                <img height="200" width="200" src="../Faculty/Faculty Image/<%#Eval("fac_img") %>" class="card-image-top" alt="Card image cap" />
                                                                <b>
                                                                    <td><%#Eval("fac_name") %></td>
                                                                    <br />
                                                                </b>
                                                                <b>
                                                                    <td><%#Eval("fac_email") %></td>
                                                                    <br />
                                                                </b>
                                                                <b>
                                                                    <td><%#Eval("pname") %></td>
