<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forget-Password.aspx.cs" Inherits="Preskool.Admin.Forget_Password" %>
...
<%--<input class="form-control" type="text">--%>
    <asp:TextBox ID="txt_email" runat="server" class="form-control" required="Please enter this field" TextMode="Email"></asp:TextBox>
<span class="profile-views"><i class="fas fa-envelope"></i></span>
</div>
<div class="form-group">
<%--<button class="btn btn-primary btn-block" type="submit">Reset My Password</button>--%>
    <asp:Button ID="btn_forget" runat="server" Text="Forget My Password" class="btn btn-primary btn-block" OnClick="btn_forget_Click" />
</div>
