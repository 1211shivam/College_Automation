                    ...
                    <form action="#" runat="server" id="form1">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <asp:TextBox ID="txt_cname" runat="server" class="form-control" placeholder="Enter Course Name" required="Please Enter Field"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <asp:TextBox ID="txt_cdesc" TextMode="MultiLine" runat="server" Rows="4" cols="5" class="form-control" placeholder="Enter Description" required="Please Enter Field"></asp:TextBox>
                            </div>
                            <div>
                            <div class="form-group row">
